...
python main_mnist.py --gpus=0 --majority-enable --majority-apx --majority_size=5 --network=SFC --epochs=100
python main_mnist.py --gpus=0 --majority-enable --majority-apx --majority_size=7 --network=SFC --epochs=100
python main_mnist.py --gpus=0 --majority-enable --majority-apx --majority_size=9 --network=SFC --epochs=100
...
python main_mnist.py --gpus=0 --majority-enable --majority-apx --majority_size=5 --network=LFC --epochs=100
python main_mnist.py --gpus=0 --majority-enable --majority-apx --majority_size=7 --network=LFC --epochs=100
