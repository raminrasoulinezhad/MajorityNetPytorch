...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        # This regime is designed by us
        # in TF repository of google, they have a dynamic lr builder. 
        # it changes the learning rate each 2.4 epoch using following numbers:
        #   decay_factor=0.97,
        #   source: https://github.com/tensorflow/tpu/tree/master/models/official/efficientnet/util.py
        self.regime = {
